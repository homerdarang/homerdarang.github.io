    ...
    return (
        <>
            <div className='flex flex-row gap-8 text-3xl text-slate-300 my-4 cursor pointer'>
                ...
                <a className='active:scale-95 outline-none hover:text-slate-100 transition-all ease-linear' href='https://www.linkedin.com/in/homerdarang/' target='_blank' rel='noreferrer'>{<FaLinkedin />}</a>
