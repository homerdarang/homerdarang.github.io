...
function AboutMe() {
    return (
        <>
            <div className='aboutme md:px-12 px-8 py-16 backdrop-blur md:bg-black/25 lg:bg-white/10 bg-white/15 rounded-3xl lg:w-5/6 lg:ms-auto text-teal-300 overflow-y-scroll scrollbox overflow-hidden text-pretty'>
